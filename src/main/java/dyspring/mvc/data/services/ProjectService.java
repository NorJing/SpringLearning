package dyspring.mvc.data.services;
...
import dyspring.mvc.data.entities.*;
...
public class ProjectService {
	...
	public Project find(Long projectId) {
		return this.projects.stream().filter(predicate -> {
			return predicate.getProjectId().equals(projectId);
